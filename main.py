...
def draw_info():
    ...
    #show score
    draw_text(f'x{player.score}', font, constants.WHITE, constants.SCREEN_WIDTH - 105, 15)
...
while run:
    #control framerate
    clock.tick(constants.FPS)  # Maintain 60 FPS
    screen.fill(constants.BG)  # Fill the screen with background color
    
    #calculate player movement delta-x and delta-y change in x and y
    dx = 0
    dy = 0
